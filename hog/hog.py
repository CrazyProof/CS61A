...
def boar_brawl(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 2
    score = abs((player_score % 10 - opponent_score // 10 % 10)) * 3
    if score == 0:
        return 1
    return score
    # END PROBLEM 2
...
def always_roll(n):
    ...
    assert n >= 0 and n <= 10
    # BEGIN PROBLEM 6
    def roll_num(player_num, opponent_num):
        return n
    return roll_num
    # END PROBLEM 6
