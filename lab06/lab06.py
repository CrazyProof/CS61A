...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        self.transactions.append(Transaction(self.call_count, self.balance - amount, self.balance))
        self.call_count += 1
        return self.balance
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.transactions.append(Transaction(self.call_count, self.balance, self.balance))
            self.call_count += 1
